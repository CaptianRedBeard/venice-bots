...
def main():
    print("=== Agent V7 - The Secure Learner (Identity-Based) ===")
    ...
    print(f"\nAgent V7 The Secure Learner started. Type 'exit' to quit.")
    print(f"This agent uses the '{persona_name}' persona with identity-based memory access.")
    print(f"Default recall target: {knowledge_base.config['memory_config'].get('default_recall_target', 'self')}\n")
